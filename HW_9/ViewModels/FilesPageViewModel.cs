...
namespace VP_lab9.ViewModels
{
    internal class FilesPageViewModel : ReactiveObject
    {
        ...
        public FilesPageViewModel()
        {
            ...
            using (var fileStream = assetLoader.Open(new Uri("avares://HW_9/Assets/file.png")))
            using (var folderStream = assetLoader.Open(new Uri("avares://HW_9/Assets/folder.png")))
            using (var folderOpenStream = assetLoader.Open(new Uri("avares://HW_9/Assets/folder-open.png")))
            {
